                        ...
                        <div className="d-flex gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-dark">
                              High School Diploma - New Delhi, India
                            </p>
                          </div>
                        </div>
                      </li>
					  <li className="position-relative z-1 mb-3">
                        <div className="d-flex gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-dark">PHP Certification</p>
                          </div>
                        </div>
                      </li>
                      <li className="position-relative z-1 mb-3">
                  ...
                  <ul className="ps-3">
                    <li className="position-relative z-1 mb-3">
                      <div className="d-flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-dark">
                            Continuous learning in React.js, Node.js, Laravel,
                    ...
                    <li className="position-relative z-1 mb-3">
                      <div className="d-flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-dark">
                            AWS and Azure deployment practices for scalable
                            applications.
                          </p>
                        </div>
                      </div>
                    ...
                    <li className="position-relative z-1 mb-3">
                      <div className="d-flex gap-2">
                        ...
                        <div>
                          <span className="text-primary-2">
                            API Integration & SaaS Applications
                          </span>
                          <p className="text-dark">
                            Specialized expertise in integrating third-party
                            services and building SaaS solutions.
                          </p>
                        </div>
                      </div>
                    </li>
