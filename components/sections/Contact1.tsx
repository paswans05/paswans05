...
<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								...
								<div className="ps-3">
									...
									<h6 className="mb-0">+91 7982691218</h6>
								</div>
								<Link href="tel:+917982691218" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								<div className="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4">
								...
								<Link href="mailto:paswans05@gmail.com" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								<div className="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4">
									<i className="ri-linkedin-fill text-primary fs-26" />
								</div>
								<div className="ps-3">
									<span className="text-400 fs-5">LinkedIn</span>
									<h6 className="mb-0">unofficialsanju</h6>
								</div>
								<Link href="https://www.linkedin.com/in/unofficialsanju" className="position-absolute top-0 start-0 w-100 h-100" target="_blank" />
							</div>
<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								<div className="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4">
								...
								<div className="ps-3">
									...
									<h6 className="mb-0">New Delhi, India 110044</h6>
								</div>
								<Link href="https://maps.google.com/maps?q=New+Delhi,+India" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
						</div>
