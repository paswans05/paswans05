					...
					<div className="container position-relative z-1 border-top border-1 pb-2 pt-4">
						<div className="text-center">
							<a className="d-flex main-logo align-items-center justify-content-center mb-3">
								...
								<span className="fs-4 ms-2">Sanjay Paswan</span>
							</a>
<div className="d-flex justify-content-center gap-3">
								<a href="https://www.facebook.com/paswans05" target="_blank">
									<i className="ri-facebook-circle-fill fs-18" />
								</a>
								<a href="https://x.com/unofficialsanju" target="_blank">
									<i className="ri-twitter-x-fill fs-18" />
								</a>
								<a href="https://linkedin.com/in/unofficialsanju" target="_blank">
									<i className="ri-linkedin-fill fs-18" />
								</a>
								<a href="https://leetcode.com/u/unofficialsanju/" target="_blank">
									<i className="ri-code-line fs-18" />
								</a>
							</div>
